...
*   **Filter Chips:** Quick toggles below the search bar:
    *   `Type:` Expense, Income, Transfer.
    *   `Mode:` UPI, Credit Card, Cash, NetBanking.
    *   `Status:` Cleared, Pending (useful for check deposits or credit card holds).
*   **Date Range Picker:** Custom ranges + presets ("This Month", "Last Month", "Financial Year - April to March").
