...
const ENTITIES_MGMT = [
  ...
  { id: 'membership', icon: ShieldCheck, title: "Memberships", sub: "Clubs & Sports", color: "text-cyan-600", bg: "bg-cyan-50" },
  // Row 3
  { id: 'giftcard', icon: Gift, title: "Gift Cards", sub: "Balances", color: "text-orange-600", bg: "bg-orange-50" },
  { id: 'inventory', icon: Package, title: "Inventory", sub: "Supplies", color: "text-orange-600", bg: "bg-orange-50" },
