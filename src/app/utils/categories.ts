...
export const DEFAULT_INCOME_CATEGORIES: CategoryDef[] = [
  ...
  },
  {
    ...
    type: "income",
    sortOrder: 1,
    aiKeywords: ["cashback", "refund", "discount", "reward"],
    subcategories: ["Discounts"],
    children: sc(["Discounts"]),
  },
  {
    id: "income_gift",
    name: "Gift",
  ...
  },
  {
    ...
    type: "income",
    sortOrder: 3,
    aiKeywords: ["interest", "fd", "savings"],
    subcategories: [],
  },
  {
    id: "income_dividends",
    ...
    type: "income",
    sortOrder: 4,
    aiKeywords: ["dividend", "stock", "mutual fund"],
    subcategories: [],
  },
  {
    id: "income_freelance",
  ...
  },
  {
    ...
    type: "income",
    sortOrder: 6,
    subcategories: ["Capital Gains", "Mutual Fund Redemption", "Rental Income"],
    children: sc(["Capital Gains", "Mutual Fund Redemption", "Rental Income"]),
  },
  {
    id: "income_others",
    name: "Others",
